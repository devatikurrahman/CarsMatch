<?php 
	...
	$sql = "SELECT * FROM `saved_vehicles` where buyer_id = '".$_SESSION['ses_user_info']['id']."' order by id desc";
...
<?php if(!empty($savedLists)): ?>
	<?php foreach($savedLists as $savedList): ?>
        <div id="modal_<?php echo $savedList['id'] ?>" style="display:none;background-color:#fff;min-width:360px;max-width:360px;height:680px;overflow:auto">
            
        
            <table class="table table-striped">
                <thead>
                    <tr class="info">
                        <th colspan="3"><?php echo $savedList['name'] ?></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td width="35%"><b>Body Type</b></td>
                        <td width="65%"><?php echo $savedList['body_style'] ?></td>       
                    </tr>
                    
                    <tr>
                        <td><b>Make</b></td>
                        <td><?php echo $savedList['make'] ?></td>  
                    </tr>
                    
                    <tr>
                        <td><b>Model</b></td>
                        <td><?php echo $savedList['model'] ?></td>    
                    </tr>
                    
                    <tr>
                        <td><b>Year</b></td>
                        <td><?php echo $savedList['year'] ?></td>  
                          
                    </tr>
                    
                    <tr>
                        <td><b>Engine</b></td>
                        <td><?php echo $savedList['engine'] ?></td>  
                          
                    </tr>
                    
                    <tr>
                        <td><b>Transmission</b></td>
                        <td><?php echo $savedList['transmission'] ?></td> 
                        
                    </tr>
                    
                    <tr>
                        <td><b>Drive</b></td>
                        <td><?php echo $savedList['drive'] ?></td> 
                        
                    </tr>
                    
                    <tr>
                        <td><b>Number of Door</b></td>
                        <td><?php echo $savedList['door'] ?></td>  
                        
                    </tr>
                    
                    <tr>
                        <td><b>Trim</b></td>
                        <td><?php echo $savedList['trim'] ?></td>  
                          
                    </tr>
                    
                    <tr>
                        <td><b>Interior Fabric</b></td>
                        <td><?php echo $savedList['internal_fabric'] ?></td>  
                        
                    </tr>
                    
                    <tr>
                        <td><b>Interior Color</b></td>
                        <td><span style="background-color:#<?php echo $savedList['interior_color'] ?>;position: relative; float: left; height: 20px; width: 20px;"></span></td> 
                           
                    </tr>
                    
                    <tr>
                        <td><b>Exterior Color</b></td>
                        <td><span style="background-color:#<?php echo $savedList['exterior_color'] ?>;position: relative; float: left; height: 20px; width: 20px;"></span></td> 
                        
                    </tr>
                    
                    <?php 
                        $package_option_arr = json_decode($savedList['opt_package']);
                    ...
                    <?php 
                        $interior_option_arr = json_decode($savedList['opt_interior']);
                    ...
                    <?php 
                        $exterior_option_arr = json_decode($savedList['opt_exterior']);
                    ...
                    <?php 
                        $additional_option_arr = json_decode($savedList['opt_additional_fees']);
                    ...
                    <?php 
                        $mechanical_option_arr = json_decode($savedList['opt_mechanical']);
                    ...
                    <?php 
                        $safety_option_arr = json_decode($savedList['opt_safety']);
                ...
                <div class="col-md-12">
                  <div data-widget="{&quot;draggable&quot;: &quot;false&quot;}" class="panel panel-info" data-widget-static="" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
                    <div class="panel-heading">
                      <h5 style="color:#fff">Saved Vehicles</h5>
                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <?php if(!empty($savedLists)): ?>
                          	<?php foreach($savedLists as $savedList): ?>
                                  <?php 
								  	$sql = mysql_query("select * from make_images where year='".$savedList['year']."' and make='".$savedList['make']."' and model='".$savedList['model']."' and trim='".$savedList['trim']."' limit 1") ;
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo $savedList['trim'] ?></td>
                                    <td>
                                    	<a class="btn btn-info" id="modal_trigger_<?php echo $savedList['id'] ?>" href="#modal_<?php echo $savedList['id'] ?>"><i class="fa fa-info"></i></a>
                                    </td>
                                  </tr>
                              <?php endforeach; ?>
                          <?php endif; ?>
...
<script>
	jQuery(document).ready(function() {
		<?php if(!empty($savedLists)): ?>	
			<?php foreach($savedLists as $savedList): ?>
				jQuery("#modal_trigger_<?php echo $savedList['id'] ?>").leanModal({top : 200, overlay : 0.6, closeButton: ".modal_close" });
			<?php endforeach; ?>
		<?php endif; ?>
	});
</script>
