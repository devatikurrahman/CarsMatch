                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-8">
                                ...
                                <div style="border:1px solid #68b7ff">
                                    ...
                                    <p style="font-size:20px;color:#595858;text-align:center;font-weight:bold;margin-top:15px;">2016 Ford F-150 SuperCab</p>
                                        ...
                                        <table cellpadding="10" cellspacing="10" width="100%">
                                            <tr>
                                                ...
                                                <td width="19%" align="center">
                                                    <p style="color:#198ef8;font-size:20px;margin-bottom:2px;font-weight:bold">07</p>
                                                    <p style="color:#198ef8;font-size:15px;margin-top:2px;font-weight:bold">DAYS</p>
                                                </td>
                                                <td width="20%" align="center">
                                                    <p style="color:#198ef8;font-size:20px;margin-bottom:2px;font-weight:bold">06</p>
                                                    <p style="color:#198ef8;font-size:15px;margin-top:2px;font-weight:bold">HOURS</p>
                                                </td>
                                                <td width="24%" align="center">
                                                    <p style="color:#198ef8;font-size:20px;margin-bottom:2px;font-weight:bold">14</p>
                                                    <p style="color:#198ef8;font-size:15px;margin-top:2px;font-weight:bold">MINUTES</p>
                                                </td>
                                                <td width="24%" align="center">
                                                    <p style="color:#198ef8;font-size:20px;margin-bottom:2px;font-weight:bold">47</p>
                                                    <p style="color:#198ef8;font-size:15px;margin-top:2px;font-weight:bold">SECONDS</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                        ...
                                        <div class="col-md-12" style="padding:0px;border:1px solid #68b7ff;border-radius:5px;">
                                            <div style="width: 100%; height:70px; padding: 5px; display: table; color: rgb(255, 255, 255) !important;">
                                                    <div style="width: 50%; padding-bottom: 5px;float:left;">
                                                        ...
                                                        <div style="float: left; width: 210px; padding-left: 10px;">
                                                            <span class="username" style="font-weight: bold;font-size: 20px; color: #4b4b4b;;display:block">Ford Dealer 1</span>
                                                            <span class="username" style="font-weight: bold;font-size: 14px; color: #939393;;display:block">2 mins ago</span>
                                                    ...
                                                    <div style="width: 40%; float: left; margin-left: 50px; background: rgba(0, 0, 0, 0) url('admin/images/match.png') no-repeat scroll 0% 0%; height: 60px; padding-top: 8px;">
                                                        <span style="padding-left:12px;font-size: 22px;">87%</span>
                                                    </div>
                                            ...
                                            <div style="width:100%;background-color:#51acff;padding:10px 5px;display:table">
                                                <div style="float: left; width: 18.5%; border-right: 1px solid rgb(255, 255, 255); margin-right: 10px; padding-right: 7px;">
                                                    ...
                                                    <span class="username" style="font-weight: bold;font-size: 20px; color: #fff;;display:block">$33,575</span>
                                                </div>
                                                ...
                                                <div style="float: left; width: 18.5%; border-right: 1px solid rgb(255, 255, 255); margin-right: 10px; padding-right: 7px;color:#eaf542">
                                                    <span class="username" style="font-weight: bold;font-size: 14px; display:block">MY LAST</span>
                                                    <span class="username" style="font-weight: bold;font-size: 14px; display:block">DIFFERENCE</span>
                                                    <span class="username" style="font-weight: bold;font-size: 20px; display:block">$33,575</span>
                                                </div>
                                                
                                                <div style="float: left; width: 18.5%;border-right:1px solid rgb(81, 172, 255);color:#eaf542">
                                                    <span class="username" style="font-weight: bold;font-size: 14px; display:block">CURRENT</span>
                                                    <span class="username" style="font-weight: bold;font-size: 14px;display:block"> DIFF. REBATE</span>
                                                    <span class="username" style="font-weight: bold;font-size: 20px; display:block">$33,575</span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="panel-body scroll-pane" style="border:1px solid #68b7ff;text-align:center;margin-bottom:20px;">
                                ...
                                <div class="panel-body scroll-pane" style="border:1px solid #68b7ff;text-align:center;height:400px;">
