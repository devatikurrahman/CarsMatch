<?php
  ...
  */
  ...
  class payflow {
    ...
    var $password;
    var $errors = '';
    var $ClientCertificationId = '13fda2433fc2123d8b191d2d011b7fdc'; // random id
    var $currencies_allowed = array('USD', 'EUR', 'GBP', 'CAD', 'JPY', 'AUD');
    var $test_mode = 0; // 1 = true, 0 = production
    ...
    function payflow($vendor, $user, $partner, $password) {
      ...
      if ($this->test_mode == 1) {
        $this->submiturl = 'https://pilot-payflowpro.paypal.com/transaction';   
      } else {
